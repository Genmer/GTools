...
import manifest from '../../../../src/plugins/time-toolbox/manifest'
...
const others = [calc, clipboard, devtools, hello, launcher, markdownNotes, translate]
...
describe('time-toolbox manifest', () => {
  it('结构合法', () => {
